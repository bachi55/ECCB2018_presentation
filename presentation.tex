...
\section[Retention order \& MS/MS score integration]{Integration of MS/MS scores \& predicted retention orders}
...
\begin{appendix}
    % Include references  
% \section{References}
\frame[t,allowframebreaks,noframenumbering]{
%     \frametitle{References}d
