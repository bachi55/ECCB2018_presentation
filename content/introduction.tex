...
\begin{itemize}
    ...
    \item Untargeted metabolomics studies: Identification of metabolites present in a biological sample
    \item Popular analysis workflow: \alert<2>{Liquid chromatography (LC)} combined with \alert<3>{tandem mass spectrometry (MS/MS)}
\end{itemize}
\end{small}

\includegraphics<1-2>[width=\textwidth]{images/lc_concept.pdf}
\includegraphics<3>[width=\textwidth]{images/lcms_spectrum_complex_no_retention_order.pdf}
}
