\frame{
    \frametitle{``Classical'' MS/MS spectra based metabolite identification} 

\begin{figure}[c]
    \centering
    \includegraphics[width=0.8\textwidth]{images/lcms_spectrum_complex_small_only_iokr.pdf}
\end{figure}
\vspace{-0.15cm}
\begin{small}
...
\begin{figure}[c]
    \centering
    \includegraphics[width=1.0\textwidth]{images/molecular_candidates_no_shortest_path.pdf}
\end{figure}
}
\only<2>{
\begin{figure}[c]
    \centering
    \includegraphics[width=1.0\textwidth]{images/molecular_candidates.pdf}
\end{figure}
}
\vspace{-0.15cm}
\begin{small}
